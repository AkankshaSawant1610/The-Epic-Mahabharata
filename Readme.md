...
# 🕉️ **Mahabharata Darshan – UI/UX Thematic Experience**
...
* Bridges **traditional knowledge with modern digital experiences**
...
```bash
git clone https://github.com/YOUR_USERNAME/mahabharata-darshan.git
cd mahabharata-darshan
```
...
Made by **Akanksha Sawant**
Theme & concept inspired by the epic **Mahabharata**
